...
const styles = StyleSheet.create({
  ...
  card: { width: 180, marginRight: 12, backgroundColor: "#fff", borderRadius: 12, overflow: "hidden", elevation: 2 },
  ...
  smallCard: { flex: 1, backgroundColor: "#fff", borderRadius: 12, overflow: "hidden", elevation: 2 },
  smallCardImage: { width: "100%", height: 100 },
  planButton: { backgroundColor: "#2563eb", padding: 16, borderRadius: 12, alignItems: "center", marginBottom: 40 },
